            ...
            var row = $(dg).datagrid('getSelected');
          	if (row) {
                $('#user-add').dialog({
                    ...
                    cache: false,
                    type : "GET",
                    href: '${basePath}manager/user/userDetail.do?userId=' + row.id,
                    modal: true
                });
            } else {
                layer.msg('必须选择一行!');
...
<div id="user-tool">
	...
	<div style="padding-top: 5px; padding-bottom: 5px; padding-left: 5px;">
		...
		<a id="user-viewBtn" href="#" class="easyui-linkbutton" plain="true" data-options="iconCls:'icon-user_gray'">用户详情</a>
	</div>
</div>
